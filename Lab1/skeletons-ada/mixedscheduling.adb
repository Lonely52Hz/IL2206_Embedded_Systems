...
procedure mixedscheduling is
   ...
   task type BackgroundTask(Id: Integer; Prio: Integer; Phase: Integer; 
   ...
   begin
		...
		WCRT := Milliseconds(0);
      loop
         --Next := Release + Milliseconds(Computation_Time);
         -- Simulation of User Function
			for I in 1..Computation_Time loop
				Dummy := F(Calibrator); 
			end loop;	
   ...
   Task_1 : T(1, 25, Warm_Up_Time, 300, 100, 300); -- ID: 1
	                                                   -- Priority: 40
    ...
    BGT_1 : BackgroundTask(1, 1, Warm_Up_Time, 100);
    BGT_2 : BackgroundTask(2, 1, Warm_Up_Time, 100);
    BGT_3 : BackgroundTask(3, 1, Warm_Up_Time, 100);
